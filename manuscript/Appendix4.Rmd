...
model_code <- NimbleCode({
  ...
  N[1, 1, 1:n_size] <- get_init_adult(mu_A_y, sigma_A_y, lower[1:n_size], 
  ...
  mu_A_y ~ dunif(priors[17, 1], priors[17, 2])
  sigma_A_y ~ dunif(priors[18, 1], priors[18, 2])

  # initial recruit size (mean and sd)
  mu_R_y ~ dunif(priors[19, 1], priors[19, 2])
  sigma_R_y ~ dunif(priors[20, 1], priors[20, 2])

  # abundance of recruits (mean and sd)
  mu_R_lambda ~ dunif(priors[21, 1], priors[21, 2])
  sigma_R_lambda ~ dunif(priors[22, 1], priors[22, 2])

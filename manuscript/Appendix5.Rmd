...
short_names <- c("log_mu_A", "sigma_A", "mu_R", "sigma_R", "xinf", "gk", 
                 "A", "ds", "sigma_G", "t0", "sigma_w", "sigma_y",
                 "beta", "alpha", 
                 "alpha_o[1]", "alpha_o[2]", "alpha_o[3]", "alpha_o_mu", 
                 "alpha_o_sd", "h_F_max", "h_M_max", "h_S_max", "h_F_k", 
                 "h_S_k", "h_F_0", "h_S_0", "h_M_A", "h_M_sigma", "ro_dir", 
                 "lambda_A", "lambda_R[1]", "lambda_R[2]", "lambda_R[3]",
                 "lambda_R[4]", "mu_lambda", "sigma_lambda")

real_names <- c("log(mu^A)", "sigma^A", "mu^R", "sigma_R",
                "x[infinity]", "k", "A", "d[s]", "sigma_G", 
                "t[0]", "sigma[w]", "sigma[y]",
                "beta", "alpha", "alpha[1]^o", "alpha[2]^o",
                "alpha[3]^o", "alpha[mu]^o", "alpha[sigma]^o",
...
latex_names <- c("log(\\mu^A)", "\\sigma^A", "\\mu^R", "\\sigma_R",
                 "x_{\\infty}", "k", "A", "d_s", "\\sigma_G",
                 "t_0", "\\sigma_w", "\\sigma_y",
                 "\\beta", "\\alpha", "\\alpha_1^o",
                 "\\alpha_2^o", "\\alpha_3^o", "\\alpha_{\\mu}^o",
                 "\\alpha_{\\sd}^o", "h_F^{max}", "h_M^{max}", "h_S^{max}",

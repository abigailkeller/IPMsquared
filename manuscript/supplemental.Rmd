...
**Table S1**: Total equilibrium abundance across all size classes, $N_{total}$ for population forecasts in response to varying removal efforts. Mean refers to the mean $N_{total}^E$ across all simulation replicates, and sd refers to the standard deviation of $N_{total}^E$ across all simulation replicates.

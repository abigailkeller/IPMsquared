...
knitr::include_graphics("C:/Users/abiga/Documents/Berkeley/Structured_Decision_Making/pop_dynamics_model/IPMsquared/figures/supplemental_map.png")
```
...
seasonal_growth <- nimbleCode({
  ...
  tau.y ~ dunif(0,100) # process error standard deviation
  tau.ranef ~ dunif(0,100) # year random effect standard deviation

...
$$
\widetilde{W_y(a)} = x_{\infty}(1-\text{exp}(-k(a-t_0) - s(a) + s(t0))) + \epsilon_y
$$
$$
...
$$
s(t_0) = \frac{Ak}{2\pi}\text{sin}(2\pi(t_0-d_s))
$$
...
short_names <- c("A", "k", "xinf", "t0", "tau_w", "tau_y", "ds")
real_names <- c("A", "k", "x[infinity]", "t[0]", "tau[w]", "tau[y]", "d[s]")
latex_names <- c("A", "k", "x_{\\infty}", "t_0", "\\tau_w", "\\tau_y", "d_s")

...
$$
S_o(x,N^T_{t_{max},y}) = \text{exp}(-\frac{\alpha_y^o \times N^T_{t_{max},y}}{x^2})
$$
...
$$
S_o(x,N^T_{t_{max},y}) = \text{exp}(-\frac{\alpha_y^o \times N^T_{t_{max},y}}{x})
$$
...
$$
S_o(x,N^T_{t_{max},y}) = \text{exp}(-(\frac{\alpha^o}{N^T_{t_{max},y}} + \frac{\psi}{x^2}))
$$

**Model 4:** additive density- and size-dependence, less steep mortality decrease with size

$$
S_o(x,N^T_{t_{max},i}) = \text{exp}(-(\frac{\alpha^o}{N^T_{t_{max},y}} + \frac{\psi}{x}))
$$

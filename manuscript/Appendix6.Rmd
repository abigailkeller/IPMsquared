...
Bayesian model checking was used to determine if the model is an adequate representation of the observed data. Fit was checked with an omnibus discrepancy function, deviance. Here, $D$ refers to the the count of removed crabs, $C(x)_{t,j,y}$, the total number of removed crabs, $C^T(x)_{t,i}$, and the number of recaptured marked crabs, $mc(x)^{mc}$:

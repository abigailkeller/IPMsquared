...
# read in data
dh_2020_catch <- readRDS("data/catch_data/DH2020_catch.rds")
dh_2021_catch <- readRDS("data/catch_data/DH2021_catch.rds")
dh_2022_catch <- readRDS("data/catch_data/DH2022_catch.rds")
dh_2023_catch <- readRDS("data/catch_data/DH2023_catch.rds")

# plots
plot_2020 <- ggplot() +
  geom_point(data = dh_2020_catch,
...
final_plot <- plot_2020 + plot_2021 + plot_2022 + plot_2023 +
  legend + plot_layout(design = layout)
ggsave("figures/Figure1_timeseries_data.svg", final_plot,

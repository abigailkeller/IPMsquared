...
for (i in 1:14) {
  ...
  saveRDS(node_names[temp], 
          paste0("data/posterior_predictive_check/new_mc/node_names_", i, ".rds"))
  saveRDS(ppSamples_via_nf[, temp],
          paste0("data/posterior_predictive_check/new_mc/PPS_", i, ".rds"))
}

# save deviance
saveRDS(deviance, "data/posterior_predictive_check/new_mc/deviance_Drep.rds")
...
# save
saveRDS(data_deviance_via_nf, "data/posterior_predictive_check/new_mc/deviance_D.rds")

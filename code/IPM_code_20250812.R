...
model_code <- nimbleCode({
  ...
  # lognormal distribution mu for instantaneous intensity of mortality
  beta_mu ~ dunif(-50, 50)
  # lognormal distribution sd for instantaneous intensity of mortality
  beta_sd ~ dunif(0, 150)
...
inits <- function() {
  list(
    ...
    beta_mu = log(0.01), beta_sd = 0.5, alpha = 0.1,
...
# save samples
saveRDS(out, "data/posterior_samples/savedsamples_IPM_20250812.rds")

...
C <- readRDS("data/model_data/counts_new.rds")
C_T <- readRDS("data/model_data/ncap_new.rds")

# read in time series constants
index <- readRDS("data/model_data/index_new.rds")
D <- readRDS("data/model_data/index_frac_new.rds")
totalt <- readRDS("data/model_data/totalt_new.rds")
totalo <- readRDS("data/model_data/totalo_new.rds")
soak_days <- readRDS("data/model_data/soak_days_new.rds")
m_index <- readRDS("data/model_data/m_index_new.rds")
f_index <- readRDS("data/model_data/f_index_new.rds")
s_index <- readRDS("data/model_data/s_index_new.rds")
recruit_intro <- readRDS("data/model_data/recruit_intro_new.rds")
additionalt <- readRDS("data/model_data/additionalt_new.rds")

# read in mark-recapture data
marked_rc <- readRDS("data/model_data/roche_mc_mark_new.rds")
catch_rc <- readRDS("data/model_data/roche_mc_catch_new.rds")

# read in mark-recapture constants - Roche Cove
D_mc_rc <- readRDS("data/model_data/mc_index_rc_new.rds")
totalo_mc_rc <- readRDS("data/model_data/roche_mc_totalo_new.rds")$n
soak_days_mc_rc <- readRDS("data/model_data/soak_days_mc_rc_new.rds")
f_index_mc_rc <- readRDS("data/model_data/f_index_mc_rc_new.rds")
s_index_mc_rc <- readRDS("data/model_data/s_index_mc_rc_new.rds")
m_index_mc_rc <- readRDS("data/model_data/m_index_mc_rc_new.rds")
...
# save samples
saveRDS(out, "data/posterior_samples/savedsamples_IPM_20250820.rds")
...
# read in samples
samples <- readRDS("data/posterior_samples/savedsamples_IPM_20250820.rds")

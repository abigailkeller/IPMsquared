...
model_code <- nimbleCode({
  ...
  for (t in 1:n_time_recap) { # time corresponds to recapture events
    ...
    hazard_mc_rc[t, 1:totalo_mc_rc[t + 1], 1:n_size] <- calc_hazard(
      totalo_mc_rc[t + 1], n_size, h_F_max, h_F_max_adj,
...
# save samples
saveRDS(out, "code/model_selection/model_selection/savedsamples_model1_rc_mc_adj.rds")
...
# read in samples
samples <- readRDS("code/model_selection/model_selection/savedsamples_model1_rc_mc_adj.rds")
